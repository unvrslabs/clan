export const queryKeys = {
  ...
  publications: (companyId: string, platform?: string) =>
    ["publications", companyId, platform] as const,
  polymarket: {
    summary: (companyId: string) => ["polymarket", "summary", companyId] as const,
    trades: (companyId: string, status?: string) =>
      ["polymarket", "trades", companyId, status] as const,
    analyses: (companyId: string) => ["polymarket", "analyses", companyId] as const,
    balance: (companyId: string) => ["polymarket", "balance", companyId] as const,
    equityHistory: (companyId: string) => ["polymarket", "equity-history", companyId] as const,
    pnlHistory: (companyId: string) => ["polymarket", "pnl-history", companyId] as const,
  },
