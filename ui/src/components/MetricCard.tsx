...
export function MetricCard({ icon: Icon, value, label, description, to, onClick }: MetricCardProps) {
  ...
  const inner = (
    <div className={`h-full px-4 py-4 sm:px-5 sm:py-5 rounded-2xl transition-all duration-200 card-border-light relative overflow-hidden${isClickable ? " hover:bg-white/[0.06] cursor-pointer" : ""}`}>
